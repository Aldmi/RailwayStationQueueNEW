...
namespace Server.Service
{
    public class TicketFactory
    {
        ...
        public TicketItem Create(ushort countElement, string ticketPrefix)
        {
            ...
            return new TicketItem() { NumberElement = _ticketNumber, CountElement = countElement, AddedTime = DateTime.Now, Prefix = ticketPrefix, CashboxId = null, CountTryHandling = 0 };
        }
    }
}